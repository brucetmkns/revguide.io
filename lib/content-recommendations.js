...
(function(root, factory) {
  ...
  class ContentRecommendationEngine {
    ...
    matchesDirectConditions(content, properties, context) {
      // displayOnAll bypasses all conditions (check both camelCase and snake_case)
    ...
    matchesTags(content, activeTags) {
      ...
      const hasMatchingTag = tagIds.some(tagId => activeTags.has(tagId));
