...
// Note: This feature requires HubSpot connection via the web app (app.revguide.io)
async function fetchHubSpotRecord(objectType, recordId) {
  console.log('[RevGuide BG] Fetching record:', objectType, recordId);

  // This feature has been deprecated - HubSpot API access now requires OAuth via the web app
  throw new Error('HubSpot API access requires connecting via app.revguide.io. Sign in to enable this feature.');
